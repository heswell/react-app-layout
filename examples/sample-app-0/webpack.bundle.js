...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyApp 	= __webpack_require__(/*! ../sample-components/MyApp */ 1);
	
	getJSON("flex-app.json", function(json)  {return renderApp(json);});
	
	function renderApp(json){
	
		return React.render(
			React.createElement(MyApp, {json: json}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DynamicContainer 	= __webpack_require__(/*! ../../lib/DynamicContainer */ 3); 
	var FlexBox = __webpack_require__(/*! ../../lib/FlexBox */ 4)
	var $__0=		 __webpack_require__(/*! ./types */ 5),AppHeader=$__0.AppHeader;
	...
	var Footer = React.createClass({displayName: "Footer",
		render:function(){
			...
			return React.createElement("div", {className: "AppStatus rect-component", style: style});
		}
	});
	...
	var MyApp = React.createClass({displayName: "MyApp",
		...
		render:function(){
			...
			var $__0=   this.props,json=$__0.json,props=(function(source, exclusion) {var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {throw new TypeError();}for (var key in source) {if (hasOwn.call(source, key) && !hasOwn.call(exclusion, key)) {rest[key] = source[key];}}return rest;})($__0,{json:1});
			...
			var $__1=  this.state,history=$__1.history,index=$__1.index;
	
			return (
		
				React.createElement(FlexBox, {className: "MyApp", flexOrientation: "column"}, 
					React.createElement(AppHeader, {onBack: this.handleBack, onForward: this.handleForward, className: "rect-component", $size: {flexBasis:60,flexGrow:0,flexShrink:0}}), 
					React.createElement(DynamicContainer, React.__spread({ref: "app"},  props, {json: history[index], className: "rect-component", onChange: this.handleChange})), 
					React.createElement(Footer, {$size: {flexBasis:32,flexGrow:0,flexShrink:0}})
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout 				= __webpack_require__(/*! ./Layout */ 7);
	var componentFromJSON 	= __webpack_require__(/*! ./util/componentFromJson */ 8);
	var shallowCloneObject  = __webpack_require__(/*! ./util/shallowCloneObject */ 9);
	var $__0=			 __webpack_require__(/*! ./util/pathUtils */ 10),addPaths=$__0.addPaths;
	var serialize 			= __webpack_require__(/*! ./serialize */ 11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Splitter 		= __webpack_require__(/*! ./Splitter */ 12);
	var refArray        = __webpack_require__(/*! ./util/refArray */ 13);
	var indexOf         = __webpack_require__(/*! ./util/indexOf */ 14);
	...
	var FlexBox = React.createClass({displayName: "FlexBox",
		...
		renderFlexibleChildren:function(){
			...
			var $__0=    this.props,children=$__0.children,onLayout=$__0.onLayout,dragContainer=$__0.dragContainer;
	
			var $__1=    this.state,dimensions=$__1.dimensions,dragging=$__1.dragging,flexPlaceholder=$__1.flexPlaceholder;
			...
			return children.reduce(	function(results, child, idx, arr)  {
				...
				if (idx === dragging){
					var dim = this.getManagedDimension();
					var style = {flexBasis:dimensions[idx][dim],flexGrow:0,flexShrink:0, backgroundColor: "black"};
					results.push(
						React.createElement("div", {className: "rect-layout placeholder", style: style})
					)
				}
	
				var $__0=  child.props,width=$__0.width,height=$__0.height;
				
				if (width = 'flex-width'){
					width = 800;
				}
				
				if (height = 'flex-height'){
					height = 400;
				}
	
				results.push(cloneWithProps(
					child,
					{
						ref: 'relay-' + idx, 
						...
						dragContainer: child.props.dragContainer || dragContainer,
						dragging: idx === dragging,
						dimension: this.getManagedDimension(),
						style : Object.assign({boxSizing:'border-box'}, child.props.style || {}, dimensions[idx]),
						width:width,
						height:height
					}
				));
		...
		getInitialState:function(){
			...
			var blah = this.getComponentsThatNeedWidthOrHeight(); 
			console.log('getComponentsThatNeedWidthOrHeight  ' + blah );
		...
		getComponentsThatNeedWidthOrHeight:function(){
	
			return this.props.children.map(function(child)  {return child.props.width === 'flex-width';});
		...
		componentDidMount:function(){
			...
			if (children.some(function(child)  {return child.props.width === 'flex-width';})){
				console.log('need width measurement for child');
			}
	
			// var el = this.getDOMNode();
	
			// console.groupCollapsed('FlexBox.componentDidMount ' + el.childNodes.length + ' child nodes');
			// console.log(Array.prototype.map.call(el.childNodes,node => node.className).join(',  '))
		...
		componentWillReceiveProps:function(nextProps){
			...
			if (nextProps.json !== this.props.json){
				this.setState({
					dimensions: nextProps.json.content.map(function(c)  {return c.$size;})
				});
			}
		},
		...
		releaseChild:function(child, style){
	        ...
	        this.setState({	dimensions:dimensions, dragging: idx, flexPlaceholder:flexPlaceholder });
		...
		drop:function(component, dropTarget){
			...
			this.props.onLayout('drop', {component:component, dropTarget:dropTarget});
		...
		onResizedWithSplitter:function(splitter){
		...
		render:function(){
			...
			return (
				React.createElement("div", {className: className, style: style}, 
					...
					React.createElement("button", {onClick: this.props.onBack}, "Back"), 
					React.createElement("button", {onClick: this.props.onForward}, "Forward")
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedStateMixin = __webpack_require__(/*! ./LinkedStateMixin */ 22);
	var React = __webpack_require__(/*! ./React */ 23);
	var ReactComponentWithPureRenderMixin =
	  __webpack_require__(/*! ./ReactComponentWithPureRenderMixin */ 24);
	var ReactCSSTransitionGroup = __webpack_require__(/*! ./ReactCSSTransitionGroup */ 25);
	var ReactTransitionGroup = __webpack_require__(/*! ./ReactTransitionGroup */ 26);
	var ReactUpdates = __webpack_require__(/*! ./ReactUpdates */ 27);
	
	var cx = __webpack_require__(/*! ./cx */ 28);
	var cloneWithProps = __webpack_require__(/*! ./cloneWithProps */ 29);
	var update = __webpack_require__(/*! ./update */ 30);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(/*! ./ReactDefaultPerf */ 31);
	  React.addons.TestUtils = __webpack_require__(/*! ./ReactTestUtils */ 32);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCloneObject = __webpack_require__(/*! ./util/shallowCloneObject */ 9);
	var transform           = __webpack_require__(/*! ./util/jsonUtils */ 15).transform;
	var $__0=     __webpack_require__(/*! ./util/pathUtils */ 10),adjustPath=$__0.adjustPath,followPath=$__0.followPath,followPathToParent=$__0.followPathToParent;
	...
	function drop(json, $__0  ){var component=$__0.component,$__1=$__0.dropTarget,targetComponent=$__1.component,pos=$__1.pos;
	    ...
	    if (sourceContainer === target){
	        ...
	        return dropIntoDifferentContainer(json, pos, source, sourceContainer, target, targetContainer);
	    }  
	...
	function dropIntoDifferentContainer(json, pos, source, sourceContainer, target, targetContainer){
	...
	function isTabset(container){
	    return container.type === LayoutType.Tabs;
	}
	
	function isTower(container){
	    return layoutType(container) === LayoutType.Tower;
	}
	
	function isTerrace(container){
	    return layoutType(container) === LayoutType.Terrace;
	}
	
	function layoutType(container){
	
	    return LayoutType[container.type + maybe(container.flexOrientation)];
	
	}
	
	function maybe(value){ return value || '';}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container 	= __webpack_require__(/*! ../Container */ 17);
	var Component 	= __webpack_require__(/*! ../Component */ 18);
	var FlexBox 	= __webpack_require__(/*! ../FlexBox */ 4);
	var PlaceHolder = __webpack_require__(/*! ../PlaceHolder */ 19);
	var Tabs		= __webpack_require__(/*! ../TabbedContainer */ 20);
	
	
	var primaryTypes = __webpack_require__(/*! ../../examples/sample-components/types */ 5);
	var components = __webpack_require__(/*! ../../examples/sample-components/components */ 21);
	
	var ReactTypes = {Container:Container, Component:Component, FlexBox:FlexBox, Tabs:Tabs, PlaceHolder:PlaceHolder};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function onDragEnd(evt){
	    ...
	    this.props.container.onResizedWithSplitter(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCloneObject = __webpack_require__(/*! ./shallowCloneObject */ 9);
	var $__0=    __webpack_require__(/*! ./pathUtils */ 10),addPaths=$__0.addPaths,adjustPath=$__0.adjustPath,followPath=$__0.followPath;
	...
	function transform(json,options){
		...
		if (nodeToBeRemoved){
	        if (nodeToBeRemoved.type === 'PlaceHolder'){
		...
		if (wrappedNode1 && wrappedNode2){
			...
			replacementNode = wrap(opts.pos, wrappedNode2, followPath(json, pathToBeReplaced));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = React.createClass({displayName: "Container",
		render:function(){
			...
			var $__0=      this.props,children=$__0.children,onLayout=$__0.onLayout,dragContainer=$__0.dragContainer,rest=(function(source, exclusion) {var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {throw new TypeError();}for (var key in source) {if (hasOwn.call(source, key) && !hasOwn.call(exclusion, key)) {rest[key] = source[key];}}return rest;})($__0,{children:1,onLayout:1,dragContainer:1});
	
			if (dragContainer === true) (dragContainer = this);
	
			var className = "rect-layout rect-container rect-tower";
	
			var childNodes = children.map(function(child, idx)  
		...
		positionChild:function(child, left, top){
			if (left !== undefined || top !== undefined){
				this.props.onLayout('position',{container:this, child:child, style:{left:left, top:top}});
			}
		},
	
		releaseChild:function(child, style){
			this.props.onLayout('release',{container:this, child:child, style:style});
		},
	
		drop:function(component, dropTarget, style){
	
			this.props.onLayout('drop', {component:component, dropTarget:dropTarget, style:style});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cx                  	= React.addons.classSet;
	var cloneWithProps      	= React.addons.cloneWithProps;
	var ComponentHeader			= __webpack_require__(/*! ./ComponentHeader */ 34);
	var ComponentContextMenu	= __webpack_require__(/*! ./ComponentContextMenu */ 35);
	
	var PopupService 		= __webpack_require__(/*! react-services */ 86).PopupService;
	
	//var BoxModel      		= require('./BoxModelCanvas');
	var BoxModelCanvas 		= __webpack_require__(/*! ./BoxModelHtml */ 36);
	var BoxModel 			= __webpack_require__(/*! ./BoxModel */ 37);
	
	var Draggable 			= __webpack_require__(/*! ./Draggable */ 38).Draggable;
	...
	var Component = React.createClass({displayName: "Component",
		...
		render:function(){
			...
			var $__0=              this.props,title=$__0.title,dragging=$__0.dragging,ref=$__0.ref,flex=$__0.flex,dimension=$__0.dimension,style=$__0.style,bg=$__0.bg,dragContainer=$__0.dragContainer,children=$__0.children,json=$__0.json,props=(function(source, exclusion) {var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {throw new TypeError();}for (var key in source) {if (hasOwn.call(source, key) && !hasOwn.call(exclusion, key)) {rest[key] = source[key];}}return rest;})($__0,{title:1,dragging:1,ref:1,flex:1,dimension:1,style:1,bg:1,dragContainer:1,children:1,json:1});
	
			var isSelected = this.props.isSelected;
	
			var isDraggable = Boolean(dragContainer);
			//onsole.log(`Component.render isDraggable=${isDraggable}`);
		...
		componentWillReceiveProps:function(nextProps){
			if (nextProps.style.flexGrow !== this.props.style.flexGrow){
				var fixed = nextProps.style.flexGrow === 0; 
				this.setState({
					fixed:fixed,
	...
	//	    var webkitTransformOrigin =  pctX + "% " + pctY + "%";
		...
		doCommand:function(command){
			if (command === 'draw-boxes'){
				...
				boxModel.draw(this.props.dragContainer)
			}
			else if (command === 'measure-boxes'){
				BoxModel.annotateWithMeasurements(this.props.dragContainer)
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React 				= window.React = __webpack_require__(/*! react/addons */ 2);
	var cx					= React.addons.classSet;
	var Tabstrip 			= __webpack_require__(/*! ./Tabstrip */ 39);
	var Tab 				= __webpack_require__(/*! ./Tab */ 40)
	var Draggable 			= __webpack_require__(/*! ./Draggable */ 38).Draggable;
	var indexOf             = __webpack_require__(/*! ./util/indexOf */ 14);
	var refArray            = __webpack_require__(/*! ./util/refArray */ 13);
	var shallowCloneObject	= __webpack_require__(/*! ./util/shallowCloneObject */ 9);
	...
	var TabbedContainer = React.createClass({displayName: "TabbedContainer",
		...
		render:function(){
			...
			var $__0=        this.props,dimension=$__0.dimension,bg=$__0.bg,style=$__0.style,isSelected=$__0.isSelected,children=$__0.children,dragContainer=$__0.dragContainer,onLayout=$__0.onLayout;
	
			var $__1=    this.state,selected=$__1.selected,dragging=$__1.dragging,dimensions=$__1.dimensions;
	
			var props = {selected:[selected||0], dragging:dragging, dragContainer:dragContainer, container:this};
			...
			var isDraggable = typeof dragContainer === 'object';
			...
			var components = children.map(function(child, idx)  {
				...
				return cloneWithProps(child, {
					...
					dragContainer : dragContainer,
					onLayout:onLayout,
					style : Object.assign({},dimensions[idx],{backgroundColor:child.props.bg})
				})
			}.bind(this));
			...
			if (nextProps.json !== this.props.json){
				...
				var dimensions = nextProps.json.content.map(function(c,idx)  {
					if (idx === nextProps.json.activeTab){
						return {flexShrink:1,flesGrow:1,flexBasis:1};
					}
					else {
						return {flexShrink:1,flesGrow:1,flexBasis:0};
					}
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var shallowEqual = __webpack_require__(/*! ./shallowEqual */ 67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(
	  __webpack_require__(/*! ./ReactTransitionGroup */ 26)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! ./React */ 23);
	var ReactTransitionChildMapping = __webpack_require__(/*! ./ReactTransitionChildMapping */ 69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var warning = __webpack_require__(/*! ./warning */ 75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDefaultPerfAnalysis = __webpack_require__(/*! ./ReactDefaultPerfAnalysis */ 79);
	var ReactMount = __webpack_require__(/*! ./ReactMount */ 57);
	var ReactPerf = __webpack_require__(/*! ./ReactPerf */ 59);
	
	var performanceNow = __webpack_require__(/*! ./performanceNow */ 80);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react/addons */ 2);
	var $__0= 	 __webpack_require__(/*! react-controls */ 147),ContextMenu=$__0.ContextMenu,MenuItem=$__0.MenuItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function gapBetweenClients(c1, c2){
		return gapBetween(c1.props.json.$clientRect, c2.props.json.$clientRect);
	}
	...
	function byClientPosition(c1, c2){
		return byPosition(c1.props.json.$clientRect, c2.props.json.$clientRect);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout                  = __webpack_require__(/*! ./Layout */ 7);
	var DropTargetCanvas        = __webpack_require__(/*! ./DropTargetCanvas */ 87);
	var refArray                = __webpack_require__(/*! ./util/refArray */ 13);
	var BoxModel                = __webpack_require__(/*! ./BoxModel */ 37);
	var BoxModelCanvas          = __webpack_require__(/*! ./BoxModelHtml */ 36);
	var DragState               = __webpack_require__(/*! ./DragState */ 88);
	var serialize               = __webpack_require__(/*! ./serialize */ 11);
	...
	function initDrag(evt){
	    ...
	    _dragContainer = _draggee.props.dragContainer === true ? _draggee.props.container : _draggee.props.dragContainer;
	...
	function dragMousemoveHandler(evt){
	    ...
	    if (_annotated === false){
	        BoxModel.annotateWithMeasurements(_draggee.props.dragContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectionModel = __webpack_require__(/*! ./SelectionModel */ 89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPerf = __webpack_require__(/*! ./ReactPerf */ 59);
	var ReactPropTransferer = __webpack_require__(/*! ./ReactPropTransferer */ 76);
	var ReactPropTypeLocations = __webpack_require__(/*! ./ReactPropTypeLocations */ 97);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(/*! ./ReactDefaultPerf */ 31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(/*! ./CSSCore */ 137);
	var ReactTransitionEvents = __webpack_require__(/*! ./ReactTransitionEvents */ 138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(/*! ./Object.assign */ 63);
	var emptyFunction = __webpack_require__(/*! ./emptyFunction */ 70);
	var getEventTarget = __webpack_require__(/*! ./getEventTarget */ 146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__0=    __webpack_require__(/*! ./PopupService */ 148),DialogService=$__0.DialogService,PopupService=$__0.PopupService,Popup=$__0.Popup;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout          = __webpack_require__(/*! ./Layout */ 7);
	var DropMenu        = __webpack_require__(/*! ./DropMenu */ 149);
	var PopupService    = __webpack_require__(/*! react-services */ 86).PopupService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__0=    __webpack_require__(/*! ./ContextMenu */ 182),ContextMenu=$__0.ContextMenu,MenuItem=$__0.MenuItem,Separator=$__0.Separator;
	var SelectBox 	= __webpack_require__(/*! ./SelectBox */ 183);
	var CheckBox 	= __webpack_require__(/*! ./CheckBox */ 184);
	//var Dialog 		= require('./dialog/Dialog');
	var TextInput	= __webpack_require__(/*! ./TextInput */ 185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropTypes			= React.PropTypes;
	var cx					= React.addons.classSet;
	var markEventAsHandled	= __webpack_require__(/*! react-utils */ 196).markEventAsHandled;
	var KeyboardHandler		= __webpack_require__(/*! react-utils */ 196).KeyboardHandler;
	var indexOf				= __webpack_require__(/*! react-utils */ 196).indexOf;
	var Popup				= __webpack_require__(/*! react-services */ 86).Popup;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var markEventAsHandled 	= __webpack_require__(/*! ./markEventAsHandled */ 201);
	var padDecimal 			= __webpack_require__(/*! ./padDecimal */ 202);
	var SelectionModel 		= __webpack_require__(/*! ./SelectionModel */ 203);
	var ExpansionModel 		= __webpack_require__(/*! ./ExpansionModel */ 204);
	var KeyboardHandler 	= __webpack_require__(/*! ./KeyboardHandler */ 205);
	var Draggable 			= __webpack_require__(/*! ./Draggable */ 206);
	var emptyFunction 		= __webpack_require__(/*! ./emptyFunction */ 207);
	var shallowEqual 		= __webpack_require__(/*! ./shallowEqual */ 208);
	var shallowCloneObject 	= __webpack_require__(/*! ./shallowCloneObject */ 209);
	var isFunction 			= __webpack_require__(/*! ./isFunction */ 210);
	var parseInt			= __webpack_require__(/*! ./parseInt */ 211);
	var parseFloat			= __webpack_require__(/*! ./parseFloat */ 212);
	var uuid				= __webpack_require__(/*! ./uuid */ 213);
	var evt 				= __webpack_require__(/*! ./evt */ 214);
	var merge 				= __webpack_require__(/*! ./merge */ 215);
	var mergeInto 			= __webpack_require__(/*! ./mergeInto */ 216);
	var invariant			= __webpack_require__(/*! ./invariant */ 217);
	var copyProperties 		= __webpack_require__(/*! ./copyProperties */ 218);
	var toLocaleString		= __webpack_require__(/*! ./toLocaleString */ 219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toArray = __webpack_require__(/*! ./toArray */ 220);
